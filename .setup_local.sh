...
# Warning
echo 'You should already have installed homebrew, brew python, .dotfiles, and ZSH with the correct paths (mackup restore).'
echo 'Exit now if you do not meet the requirements.'
...
# cd ~/.dotfiles/local_setup && brew bundle && cd ~/
...
sudo scutil --set ComputerName "JPMacBook"
sudo scutil --set HostName "JPMacBook"
sudo scutil --set LocalHostName "JPMacBook"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "JPMacBook"
